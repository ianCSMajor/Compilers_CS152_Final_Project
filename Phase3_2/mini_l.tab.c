...
{
       0,    93,    93,    96,    97,    98,   108,   109,   110,   111,
     112,   113,   114,   115,   118,   119,   120,   121,   122,   122,
     123,   123,   124,   124,   125,   125,   126,   127,   128,   129,
     130,   133,   134,   135,   136,   139,   140,   141,   142,   143,
     144,   145,   146,   147,   148,   149,   162,   163,   176,   177,
...
#line 114 "mini_l.y"
                                                             {stringstream ss; ss << ". " << (yyvsp[-3].node).ret << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1571 "mini_l.tab.c"
    break;

  case 13:
#line 115 "mini_l.y"
                                                                                                 {stringstream ss; ss << ".[] " << (yyvsp[-8].node).ret << ", " << (yyvsp[-3].node).ret << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1577 "mini_l.tab.c"
    break;

  case 14:
#line 118 "mini_l.y"
                                           {stringstream ss; ss << (yyvsp[-2].node).code << (yyvsp[0].node).code; (yyval.node).code = strdup(ss.str().c_str());}
#line 1583 "mini_l.tab.c"
    break;

  case 15:
#line 119 "mini_l.y"
           {(yyval.node).code = (char*)"";}
#line 1589 "mini_l.tab.c"
    break;

  case 16:
#line 120 "mini_l.y"
                                     {stringstream ss; ss << (yyvsp[0].node).code << "= " << (yyvsp[-2].node).ret << ", "  << (yyvsp[0].node).ret << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1595 "mini_l.tab.c"
    break;

  case 17:
#line 121 "mini_l.y"
                              {stringstream ss; ss << (yyvsp[0].node).code << "[]= " << (yyvsp[-2].node).ret << ", " << (yyvsp[-2].node).i << ", " << (yyvsp[0].node).ret << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1601 "mini_l.tab.c"
    break;

  case 18:
#line 122 "mini_l.y"
                     {loopScope = true;}
#line 1607 "mini_l.tab.c"
    break;

  case 19:
#line 122 "mini_l.y"
                                                          {loopScope = false;}
#line 1613 "mini_l.tab.c"
    break;

  case 20:
#line 123 "mini_l.y"
                     {loopScope = true;}
#line 1619 "mini_l.tab.c"
    break;

  case 21:
#line 123 "mini_l.y"
                                                                          {loopScope = false;}
#line 1625 "mini_l.tab.c"
    break;

  case 22:
#line 124 "mini_l.y"
                             {loopScope = true;}
#line 1631 "mini_l.tab.c"
    break;

  case 23:
#line 124 "mini_l.y"
                                                                    {loopScope = false; stringstream ss; (yyval.node).loop = curr_loop++; ss << ": beginloop" << (yyval.node).loop << "\n" << (yyvsp[-4].node).code << "?:= loopbody" << (yyval.node).loop << ", " << (yyvsp[-4].node).ret << "\n:= endloop" << (yyval.node).loop << "\n: loopbody" << (yyval.node).loop << "\n" << (yyvsp[-1].node).code << ":= beginloop" << (yyval.node).loop << "\n: endloop" << (yyval.node).loop << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1637 "mini_l.tab.c"
    break;

  case 24:
#line 125 "mini_l.y"
                 {loopScope = true;}
#line 1643 "mini_l.tab.c"
    break;

  case 25:
#line 125 "mini_l.y"
                                                                       {loopScope = false;}
#line 1649 "mini_l.tab.c"
    break;

  case 26:
#line 126 "mini_l.y"
                  {(yyval.node).code = strdup((yyvsp[0].node).code);}
#line 1655 "mini_l.tab.c"
    break;

  case 27:
#line 127 "mini_l.y"
                    {(yyval.node).code = strdup((yyvsp[0].node).code);}
#line 1661 "mini_l.tab.c"
    break;

  case 28:
#line 128 "mini_l.y"
             {if(!loopScope) {printf("Error line %d: continue statement not within a loop.\n", l); errorRaised = true;}}
#line 1667 "mini_l.tab.c"
    break;

  case 29:
#line 129 "mini_l.y"
          {(yyval.node).code = (char*)"";}
#line 1673 "mini_l.tab.c"
    break;

  case 30:
#line 130 "mini_l.y"
                      {stringstream ss; ss << (yyvsp[0].node).code << "ret " << (yyvsp[0].node).ret << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1679 "mini_l.tab.c"
    break;

  case 31:
#line 133 "mini_l.y"
                  {stringstream ss; ss << ".< " << (yyvsp[0].node).ret << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1685 "mini_l.tab.c"
    break;

  case 32:
#line 134 "mini_l.y"
            {stringstream ss; char* t = strdup(var_generator()); ss << ". " << t << "\n=[] " << t << ", " << (yyvsp[0].node).ret << ", " << (yyvsp[0].node).i << "\n.< " << t << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1691 "mini_l.tab.c"
    break;

  case 33:
#line 135 "mini_l.y"
                   {stringstream ss; ss << ".> " << (yyvsp[0].node).ret << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1697 "mini_l.tab.c"
    break;

  case 34:
#line 136 "mini_l.y"
            {stringstream ss; char* t = strdup(var_generator()); ss << ". " << t << "\n=[] " << t << ", " << (yyvsp[0].node).ret << ", " << (yyvsp[0].node).i << "\n.> " << t << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1703 "mini_l.tab.c"
    break;

  case 35:
#line 139 "mini_l.y"
                                          {stringstream ss; (yyval.node).ret = strdup(var_generator()); ss << (yyvsp[-3].node).code << (yyvsp[-2].node).code << (yyvsp[0].node).code << ". " << (yyval.node).ret << "\n" << (yyvsp[-1].node).code << " " << (yyval.node).ret << ", " << (yyvsp[-2].node).ret << ", " << (yyvsp[0].node).ret << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1709 "mini_l.tab.c"
    break;

  case 37:
#line 141 "mini_l.y"
               {(yyval.node).code = (char*)"";}
#line 1715 "mini_l.tab.c"
    break;

  case 38:
#line 142 "mini_l.y"
           {(yyval.node).code = (char*)"";}
#line 1721 "mini_l.tab.c"
    break;

  case 39:
#line 143 "mini_l.y"
         {(yyval.node).code = (char*)"==";}
#line 1727 "mini_l.tab.c"
    break;

  case 40:
#line 144 "mini_l.y"
        {(yyval.node).code = (char*)"!=";}
#line 1733 "mini_l.tab.c"
    break;

  case 41:
#line 145 "mini_l.y"
       {(yyval.node).code = (char*)"<";}
#line 1739 "mini_l.tab.c"
    break;

  case 42:
#line 146 "mini_l.y"
       {(yyval.node).code = (char*)">";}
#line 1745 "mini_l.tab.c"
    break;

  case 43:
#line 147 "mini_l.y"
        {(yyval.node).code = (char*)"<=";}
#line 1751 "mini_l.tab.c"
    break;
...
#line 1775 "mini_l.tab.c"
    break;

  case 46:
#line 162 "mini_l.y"
           {(yyval.node).code = (char*)"";}
#line 1781 "mini_l.tab.c"
    break;
...
#line 1799 "mini_l.tab.c"
    break;

  case 48:
#line 176 "mini_l.y"
           {(yyval.node).code = (char*)"";}
#line 1805 "mini_l.tab.c"
    break;

  case 49:
#line 177 "mini_l.y"
              {(yyval.node).code = (char*)"+";}
#line 1811 "mini_l.tab.c"
    break;

  case 50:
#line 178 "mini_l.y"
        {(yyval.node).code = (char*)"-";}
#line 1817 "mini_l.tab.c"
    break;

  case 51:
#line 179 "mini_l.y"
           {(yyval.node).code = (char*)"";}
#line 1823 "mini_l.tab.c"
    break;

  case 52:
#line 180 "mini_l.y"
                     {(yyval.node).code = (char*)"*";}
#line 1829 "mini_l.tab.c"
    break;

  case 53:
#line 181 "mini_l.y"
        {(yyval.node).code = (char*)"/";}
#line 1835 "mini_l.tab.c"
    break;

  case 54:
#line 182 "mini_l.y"
        {(yyval.node).code = (char*)"%";}
#line 1841 "mini_l.tab.c"
    break;

  case 55:
#line 183 "mini_l.y"
           {(yyval.node).code = (char*)"";}
#line 1847 "mini_l.tab.c"
    break;

  case 56:
#line 184 "mini_l.y"
              {(yyval.node).ret = strdup((yyvsp[0].node).ret); (yyval.node).code = (char*)"";}
#line 1853 "mini_l.tab.c"
    break;

  case 57:
#line 185 "mini_l.y"
            {stringstream ss; (yyval.node).ret = strdup(var_generator()); ss << ". " << (yyval.node).ret << "\n=[] " << (yyval.node).ret << ", " << (yyvsp[0].node).ret << ", " << (yyvsp[0].node).i << "\n"; (yyval.node).code = strdup(ss.str().c_str());}
#line 1859 "mini_l.tab.c"
    break;

  case 58:
#line 186 "mini_l.y"
            {(yyval.node).ret = strdup((yyvsp[0].node).ret); (yyval.node).code = (char*)"";}
#line 1865 "mini_l.tab.c"
    break;

  case 59:
#line 187 "mini_l.y"
                               {(yyval.node).ret = strdup((yyvsp[-1].node).ret); (yyval.node).code = strdup((yyvsp[-1].node).code);}
#line 1871 "mini_l.tab.c"
    break;
